...
(function make_xlsx(XLSX) {
  ...
  var fs;
	...
	var current_codepage = 1200, current_cptable, cptable, QUOTE, _hashIndex, _listIndex, style_builder;
	...
	if (typeof exports !== 'undefined') {
		if (typeof module !== 'undefined' && module.exports) {
			...
			if (typeof jszip === 'undefined') {
				console.log('use context require zipjs')
				jszip = require('jszip')
			}
		}
	}
			...
			default:
				switch (size) {
					...
					case 4:
						...
						else { oR = __readUInt32LE(this, this.l); this.l += 4; return oR; } case 8: if (t === 'f') { oR = __double(this, this.l); this.l += 8; return oR; }
					/* falls through */
	...
	*/
	...
	function write_zip_type(wb, opts) {
		...
		switch (o.type) {
			case "base64": return z.generateAsync({type:"base64"}).then( res => res);
			case "binary": return z.generateAsync({type:"string"}).then( res => res);
			case "buffer": return z.generateAsync({type:"nodebuffer"}).then( res => res);
			case "file": return z.generateAsync({type:"nodebuffer"}).then( res =>  _fs.writeFileSync(o.file,res));
			default: throw new Error("Unrecognized type " + o.type);
		}
	}
